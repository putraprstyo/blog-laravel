    ...
    <div class="col-lg-8">
        <form action="/dashboard/blog/{{$blog->slug}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" autofocus required value="{{old('title', $blog->title)}}" name="title" class="form-control @error('title') is-invalid @enderror" id="title">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{old('slug', $blog->slug)}}" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" readonly required>
                @error('slug')
                    </div class="invalid-feedback">
                        {{$message}}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="category_id">
                    @foreach ($categories as $cat)
                        @if (old('category_id', $blog->category_id) == $cat->id)
            ...
            <div class="mb-3">
                ...
                @enderror
                <input id="body" required type="hidden" name="body" value="{{old('body', $blog->body)}}">
